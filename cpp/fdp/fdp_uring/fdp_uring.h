...
#undef CMD_INC_FILE
#define CMD_INC_FILE plugins/fdp_uring/fdp_uring

#if !defined(FDP_URING_NVME) || defined(CMD_HEADER_MULTI_READ)
#define FDP_URING_NVME

#include "cmd.h"

PLUGIN(NAME("fdp_uring", "Flexible Data Placement using io_uring", NVME_VERSION),
	COMMAND_LIST(
