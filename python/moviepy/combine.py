...
mp4_file_name = "cc_" + os.path.basename(os.path.normpath(dir_path)) + ".mp4"
mp3_file_name = "cc_" + os.path.basename(os.path.normpath(dir_path)) + ".mp3"
...
# clip.write_videofile(mp4_file_name, codec='libx264', fps=24, threads=4)
clip.write_audiofile(mp3_file_name, 22050, codec='libmp3lame', ffmpeg_params=["-ac", "1"])
